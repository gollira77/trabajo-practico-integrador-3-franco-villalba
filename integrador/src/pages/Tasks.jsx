...
const TasksPage = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        idToEdit ? handleUpdateTask() : handleCreateTask();
    };
            ...
            <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <section className="md:col-span-1">
                    <h2 className="text-2xl font-semibold mb-4 text-white">
                        {idToEdit ? "Editar" : "Crear"} <span className="text-red-500">Tarea</span>
                    </h2>
                    ...
                    >
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-lg bg-zinc-950 border border-zinc-800"
                        ...
                        <button
                            type="submit"
                            className="w-full py-2.5 bg-red-600 hover:bg-red-700 rounded-lg font-medium"
                        >
                        ...
                        {idToEdit && (
                            <button
                                ...
                                className="w-full py-2.5 bg-zinc-700 hover:bg-zinc-600 rounded-lg font-medium"
                            >
                                Cancelar Edición
                            </button>
                        )}
                ...
                <section className="md:col-span-2">
                    ...
                    <div className="bg-zinc-900/60 p-6 rounded-2xl border border-zinc-800 relative min-h-[200px]">
                        {loading && <Loading />}
